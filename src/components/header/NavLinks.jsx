...
const NavLinks = () => {
  ...
  const links = [
    ...
    //   ),
    //   text: "Casino",
    //   buttonClass: "active-btn-display d-none", // Add this class to hide on mobile
  ...
  return (
    <div className="flex items-left lg:items-center justify-start lg:justify-left space-x-2 no-scrollbar overflow-scroll py-0.5 py-2 px-1">
