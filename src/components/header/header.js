        ...
        return (
            <>
                <div className={'d-flex flex-column'}>
                    ...
                    <Navbar expand="md"
                            className={`${(scrollPosition || !showDownload) && 'fixed-top-nav'} mb-0 ck pt-sm-0 pt-md-2 pc os app-navbar ${slip||jackpot && "top-betslip-page-fix"} ${user ? 'top-nav-login' : 'top-nav-login'}`}
