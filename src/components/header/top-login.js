            ...
            dispatchRedux(loginUser(initialValues))
                .then(() => {
                    ...
                    if (successMessage) {
                        ...
                        // const data = {
                        //     user_id: successMessage?.user?.profile_id,
                        ...
                        message = {
                            status: 400,
                            message: errorMessage || "Error attempting to login"
                        }
                        // ...
                        // const data = {
                        //     msisdn: values?.msisdn,
            ...
            <Dropdown.Menu class="countryCode">
              ...
              {/* Add more country codes as needed */}
                            ...
                            <div className={`text-warning`}>
                                <Switch id={"remember-me"} {...label} className="odds-change-box"
                                        name={"accept_all_odds_change"} defaultChecked color="primary"/> Remember Me
                            </div>
                        </span>
                            </div>
                            ...
                            <Row className={`${login ? "d-flex" : "d-none"}`} style={{float: "right"}}>
                                <div className="col-12">
                                    <Link className={`${login ? "d-flex justify-content-center w-100" : ""}`}
                                          to={"/signup"} title="Join now" onClick={() => gaEventTracker('Register')}>
