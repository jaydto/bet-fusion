...
const EmptyTextRow = (props) => {
  ...
  return (
    <button
      ...
      } btn home-team  btn btn-disabled   c-btn `}
      style={{
        width: "100%",
        height: "35px",
        paddingBottom: "5px",
        color: "#fff",
        background: "#2D4352 !important",
        opacity: 1,
        lineHeight: "3",
      }}
    >
  ...
  const markets = [
    {
      ...
      name: "Over/Under 2.5",
      extra_market_cols: 2,
      extra_markets_display: ["Under", "Over"],
    },
    {
      id: "10",
      name: "Double Chance",
      extra_market_cols: 3,
      extra_markets_display: ["1X", "X2", "12"],
    },
    {
      id: "29",
      name: "Both Teams to Score",
      extra_market_cols: 2,
      extra_markets_display: ["NO", "YES"],
    },
    {
      id: "219",
...
const MatchHeaderRow = (props) => {
  ...
  const [sportName, setSportName] = useState(sport?.[0]?.sport_name!==undefined&&sport?.[0]?.sport_name || 'Soccer');
  ...
  return (
    <Row
      className={`full-mobile sticky-top ${
        jackpot ? "sticky-jackpot " : "sticky-responsive "
      }px-lg-3`}
    >
      <div
        className="top-matches d-flex position-sticky sticky-top shadow-lg"
      ...
      >
        <div className={"size-info  d-flex col-xs-12 pad left-text"}>
          <div className="col pad left-text d-flex">
            <div className="align-self-center col">
              <h3 className="main-heading-1 text-white px-3">
        ...
        <div
          className={
            "col  to-deskview flex-row justify-content-between space-bets"
          }
          style={{ minWidth: "45%" }}
        >
          {threeWay && !jackpot && (
...
export const MatchRow = (props) => {
  ...
  let sport = categories?.all_sports?.filter(
    (category) => category.sport_id == sport_id
  );
  ...
  return (
    <div className="top-matches d-flex flex-sm-column flex-lg-row ">
      <div className="to-deskview to-block to-tabview  mx-lg-0 px-sm-4 px-md-4 px-lg-0  py-lg-0 container-size ">
        <div className="size-info  d-flex col-xs-12 pad left-text flex-row live-col">
          ...
          <div
            className={`col align-items-center col-xs-12 match-detail-container change-match  ${
              jackpot
                ? "align-self-center jackpot-spacing"
                : " only-mobile  px-1"
            }`}
          >
            <div>
            ...
            >
              <div className="compt-teams d-flex flex-xl-column flex-column ">
                ...
                <div className={"bold team"}>{match.away_team}</div>
              </div>
              <div className={`d-flex flex-column ${jackpot ? "" : "px-2"} `}>
        ...
        <div className="col d-flex  flex-row space-bets justify-content-lg-between ">
          ...
          <div className="c-btn-group align-self-center to-flex-1 to-tabview justify-content-end">
            <div className="d-flex flex-row px-1 justify-content-end change-date1 mobile-only">
              <div className="d-flex flex-row ">
                <div className="d-flex  text-center text-white fit-ipad w-100 justify-content-end">
                  <span className={"date-size wrapping px-3"}>
                    ...
                    {jackpot
                      ? new Date(match?.start_time).getHours() +
                        ":" +
                        new Date(match?.start_time).getMinutes()
                      : ""}
                  </span>
                  {/* {console.log("match_time",match?.start_time)} */}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="d-flex">
            ...
            {/*mobile tablet display and odds*/}
            <div
              className={"to-profile-check c-btn-group separations to-flex-2"}
            >
          ...
          <div className={"to-tabview mobile-only justify-content-end w-100"}>
            {!pdown && (
              <SideBets
                match={match}
                jackpot={jackpot}
  ...
  const randomize = async () => {
    matches?.data?.forEach((match, index) => {
      ...
      let selection =
        ...
        team.toString();
      document
        .querySelectorAll('button[custom="' + selection + '"]')
        .forEach((el) => {
      ...
      <div className={"row d-flex flex-row justify-content-between shadow-lg"}>
        <div className="col-md-12 text-center shadow-lg">
          ...
          <div className={"col-md-12 text-center"}>
            <button
              className={
                "btn btn-square btn-lg  place-bet-btn bold mb-1 bg-warning"
              }
