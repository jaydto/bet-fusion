...
const EmptyTextRow = (props) => {
    ...
    return (
        <button
            className={`${classname} ${allMarkets ? ' all-markets ' : ''} home-team btn btn-disabled match-detail c-btn ${live ? "c-resize" : "width-button-odd"}`}
            style={{
                width: "100%",
                height: "40px",
                padding: "2px",
        ...
        <div className="top-matches match">
            ...
            {markets &&
                markets.map((mkt_odds, index) => {
                    console.log("Mapping market now ", mkt_odds)
                    return (
                        <>
                            <Col
                                key={index}
