...
import { getJackpotBetslip, removeFromJackpotSlip } from "../utils/betslip";
...
const JackpotMenu = React.memo((props) => {
    ...
    <div className={"jp-placebet-container"}>
      ...
      <table className="mobile-menu mobile-menu-jackpot jackpot-menu jp-placebet-container">
        <tbody>
          ...
          >
            <td
              className={"bet-align-left-jackpot bold"}
              style={{ fontSize: "15px" }}
            >
              Bet Amount
            </td>
            <td
              className={"bet-align-left-jackpot bold"}
              style={{ color: "var(--gold)", fontSize: "15px" }}
            >
              {jackpot_stake}/=
            </td>
          </tr>
          <tr className={"d-flex w-100 justify-content-between px-4"}>
            <td className={`d-flex align-items-center bet-align-left w-100`}>
              <div className="d-flex align-items-center w-100 justify-content-between ">
                <div
                  className={
                    "d-flex align-items-center flex-column bold jackpot-autopick"
                  }
                  onClick={randomize}
                  style={{ fontSize: "15px" }}
                >
                ...
                <div className="place_jackpot_bet">
                  <div id="odd-change-text-submit" onClick={handlePlaceBet}>
                    <div
                      className={
                        "d-flex bet-select-values w-100 mt-2 p-lg-2 p-md-2 py-sm-0"
                      }
                      ...
                      <Formik>
                        <Form>
                          ...
                          <SubmitButton
                            ...
                            button_size={true}
                            disabled={(Object.keys(jackpot_data || getJackpotBetslip() || {})
                                ?.length === Number(jackpot_games) ? false : true)??loading }
                            title={
                              loading ? (
                                <div
                                  className={
                ...
                <div>
                  <span style={{ color: "var(--light)", fontWeight: "600" }}>
                    ...
                    {getJackpotBetslip() != null ? (
                      <strong>
                        {
                          Object.keys(jackpot_data || getJackpotBetslip())
                            ?.length
                        }
                      </strong>
                    ) : (
