...
const SearchModal = () => {
  ...
  const { casino_games_data_search, casino_games_providers_search } =
    useSelector((state) => state.virtuals);
  ...
  if (!state?.searching && !state?.searching_nav) return null;
        ...
        <div className="mb-3 w-100">
          {/* <div className="input-group position-relative">
            ...
            <FontAwesomeIcon
              ...
              style={{ color: "var(--light)", fontSize: "15px" , zIndex: "2"}}
            />
          </div> */}
            ...
            {(location.pathname.includes("crashgames")
              ...
              onClick={(event) => toggleOverlay(event, game.game_id)}
                ...
                <div
                  ...
                  // onClick={(event) =>
                  //   handleGameClick(event, game.game_id, false, game.game_name)
                  // }
                >
                  <img
                    src={game.image_url}
                  ...
                  />
                  <div className="casino-search-info">
                    <p>{game.game_name}</p>
                    <span>{game.provider_name}</span>
                  </div>
