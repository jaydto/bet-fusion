    ...
    return (
        ...
        <Modal show={isOpen}
            ...
            <Modal.Header closeButton={false} className={"w-100"} style={{borderBottom:"0px"}}>
                <Modal.Title className={"w-100"}>
                    <div className={"d-flex justify-content-between align-items-center"}>
                        <strong style={{width:"100%", textAlign:"center", fontSize:"19px", fontWeight:"bolder", letterSpacing:"2px"}}>LOGIN</strong>
            ...
            <Modal.Footer className={'text-center  d-flex '} style={{borderTop:"0px", width: "98%"}}>
                ...
                <Button type="submit" onClick={handleSubmit} className={" col btn btn-warning "} style={{padding:"7px",  fontSize:"12px"}}>VERIFY</Button>
            </Modal.Footer>
        </Modal>
        </>
