        ...
        return (
            <div className={`container`} style={Styles.bet} key={bet.bet_id}>
                <div className="row">
                    ...
                    { canCancel == false 
                        ? <div className={`col `}><span className={` badge ${betStatus=="LOST"?"bg-dark ":betStatus=="WON"?"bg-success":""}`} style={{color:"white"
        ...
        return (
            <div className={`container kumbafu`}  key={betslip.game_id}>
                <div className="row">
                    ...
                    <div className="col"><span className={` badge ${betslip.status=="LOST"?"bg-dark ":betslip.status=="WON"?"bg-success":""}`} style={{color:"white"
                        ,marginTop:"10px", borderRadius: "7px", marginLeft:"1px", padding:"2.9px 9px "}}>{betslip.status=="LOST"?"NOT WON":betslip.status}</span></div></div>
                </div>
            </div>
        )
    }
