            ...
            <div className="tabcontent pt-2 pb-2">
                <div className="sport_dropdowns">
                    <div className="double-chance-market text-start" style={{marginLeft:'1rem'}}>
                        <Button  to={`/nare-league?sub_type_id=3`} type="button" choice={pathname.includes(`sub_type_id=3`)&& 'kiron-more-button-color '} className={`more-market-button btn size-market-kiron size-market-kiron ${pathname.includes(`sub_type_id=3`)&& 'kiron-more-button-color '} `} onClick={()=>handleMarketChoice(3)}>1X2</Button>
                    </div>
