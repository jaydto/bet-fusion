            ...
            <div className="tabcontent pt-2 pb-2">
                <div className="sport_dropdowns">
                    <div className="double-chance-market text-start" style={{marginLeft:'1rem'}}>
                        <Button  to={`/?sub_type_id=3`} type="button" choice={pathname.includes(`sub_type_id=3`)&& 'kiron-more-button-color '} className={`more-market-button btn size-market-kiron size-market-kiron ${pathname.includes(`sub_type_id=3`)&& 'kiron-more-button-color more-market-default '} `} onClick={()=>handleMarketChoice(3)}>1X2</Button>
                    </div>
                    <div className="double-chance-market text-center">
                        <Button  to={`/?sub_type_id=14`} choice={pathname.includes(`sub_type_id=14`)&& 'kiron-more-button-color '}type="button" className={`more-market-button btn remove-on-smaller-screen size-market-kiron  ${pathname.includes(`sub_type_id=14`)&& 'kiron-more-button-color '} `} onClick={()=>handleMarketChoice(14)}>Goal/No Goal</Button>
                    </div>
                    <div className="double-chance-market text-center">
                        <Button  to={`/?sub_type_id=8`} type="button" choice={pathname.includes(`sub_type_id=8`)&& 'kiron-more-button-color '} className={`more-market-button btn remove-on-smaller-screen size-market-kiron  ${pathname.includes(`sub_type_id=8`)&& 'kiron-more-button-color '} `}onClick={()=>handleMarketChoice(8)}>Over/Under 2.5</Button>
                    </div>
