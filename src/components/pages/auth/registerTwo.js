...
const Register = () => {
    ...
    // Moved these state variables out of the nested Form component
    // to prevent re-mounting and losing input focus on every keystroke
    ...
    }, [successMessage, errorMessage, navigate, settings]);
    ...
    const validate = (values) => {
        ...
        // Improved regex to correctly validate exact 12-digit format (2547XXXXXXXX or 2541XXXXXXXX)
    ...
    const handleSubmit = (values, { setSubmitting }) => {
        ...
        dispatch(signupUser(payload))
            .then(() => {
                ...
                setSubmitting(false); // Reset submit state after success
            })
            .catch((error) => {
                notification.error({
                    message: "Registration Failed",
                ...
                setSubmitting(false); // Reset submit state on error
            });
    };
                    ...
                    <div className="auth-card-grid">
                        ...
                        <div className="auth-card-body">
                            ...
                            <Formik
                                ...
                                validate={validate}
                                // Removed validateOnChange={false} & validateOnBlur={false}
                                // to allow real-time input feedback
                            >
                                {({ errors, values, handleChange, isSubmitting }) => (
                                    <Form>
                                        ...
                                        {/* Integrated 'isSubmitting' flag so it appropriately disables pending responses */}
                                        <button
                                            type="submit"
                                            className="auth-submit-btn"
                                            disabled={!values.agreementCheckbox || isSubmitting}
                                        >
