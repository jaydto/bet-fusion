...
const RegisterTwo = props => {
    ...
    return (<>
            ...
            <div style={{height: '100vh', background: '#16202C'}}>
                <div className={''}>
                    <Navbar expand="md" className="mb-0 ck pc os app-navbar top-nav top-register-page" fixed="top"
                ...
                <div id="multi-step-form-container">
                    ...
                    <div id="userAccountSetupForm" name="userAccountSetupForm">
                        ...
                        <section id="step-3" className="form-step d-none">
                            <h2 className="font-normal align-header-referal">Do you have a referral code? Enter Here or
                                Click Complete</h2>
                            {/*<VerifyAccountForm/>*/}
                            <ReferalForm/>
                            <div className="mt-3 d-flex justify-content-between">
