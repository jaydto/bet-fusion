    ...
    <>
      ...
      <div>
        <div className={"d-flex"}>
          <div
            className="gz home top-spacing-casino "
            style={{ width: "100%" }}
          >
                    ...
                    {categories?.map(
                      (category, index) =>
                        category?.game_type_id !== "rgs-vsb" && (
                          <Button
                            bg={activeCategory === category?.game_type_id?"warning":'default'}
                            key={index}
                            style={{ marginRight: "2px" }}
                            className={`cursor-pointer text-center casino-category ${activeCategory === category?.game_type_id?' active-category ':''} casino-category-button`}
                  ...
                  >
                    ...
                    state?.casino_search.length > 0
                          ...
                          search_game?.game_id == "rgs-vsv" ? (
                            ...
                            >
                              ...
                              >
                                <div
                                  onClick={() =>
                                    launchGame(search_game?.game_id, true)
                                  }
                                  className=""
                                ...
                                <div className="overlay shadow-sm row">
                                  <ButtonGroup aria-label="Basic example">
                                    <Button
                                      variant="warning"
                                      onClick={() =>
                                        launchGame(search_game?.game_id, false)
                                      }
                                    >
                                      Play Demo
                                    </Button>
                      ...
                      : games?.reduce((result, game, index) => {
                          ...
                          if (game?.game_type_id === "vs" && activeCategory==='popular') {
