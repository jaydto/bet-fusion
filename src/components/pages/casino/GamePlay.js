                    ...
                    <div className="col-md-12">
                        <div className="homepage">
                            ...
                            {pathname=="1301"||pathname.includes("1301")&&
                                <div className={'card rounded-3 e '} style={{color:"#999",background:"transparent", textDecoration:"none", listStyle:"none"}}>
                                    <div className={'card-body p-3'}>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                Win big cash prizes when you hit the top spot and collect UPTO x5000. The multiplier always starts from 1X and goes UPTO a maximum of 5,000X.
                                            </li>
                                            <li>
                                                Minimum Bet – KSH20, Maximum Win Per Spaceman Bet is KES 1,500,000.</li>
                                            <li>
                                                CashOut before the spaceman crashes. Get high profits the longer Spaceman flies.
                                            </li>
                                            <li >
                                        ...
                                        <ul>
                                            <li >
                                                Interact with a detailed bet history, statistics with a leader board showing actual Stakes and Wins. The Live chat indicates real time conversation amongst all the SpaceMan players. See up to 500 last results with each round details.</li >
                                            <li>Play JetX only on BetNare. Click here to play https://betnare.com/smart-play?game=JetX&category=JetX  </li>
                                            <li >
                                                SpaceMan is available to NEW and EXISTING customers on the platform    </li>
                                            <li>
                                                Play Now on https://betnare.com/gameplay/1301/1
                                            </li>
                                        </ul>
