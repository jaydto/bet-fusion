...
export default function Footer() {
    ...
    return (
        <AntFooter
            style={{
                background: "var(--bet-fusion-footer)",
        ...
        >
            <Row justify="center">
                <Col span={24} style={{ maxWidth: 960, margin: "0 auto" }}>
                    ...
                    {/* License */}
                    <Title level={5} style={{ color: "var(--footer-color)", marginBottom: 8, fontWeight: 700 }}>
                        License Information
                    </Title>
                    <ul style={{ fontSize: 13, color: "var(--footer-links)", listStyle: "none", paddingLeft: 0, lineHeight: 1.8, margin: 0 }}>
                        <li>
                            Only individuals aged{" "}
                            <b style={{ color: "var(--footer-color)" }}>18 years or older</b>{" "}
                            are permitted to play.{" "}
                            <Badge count="18+" style={{ backgroundColor: "transparent", border: "1px solid var(--secondary)", color: "var(--footer-color)" }} />
                        </li>
                        ...
                        <li>License Number: <b style={{ color: "var(--footer-color)" }}>PG0001119 / BK0001120</b></li>
                    </ul>

                    <Divider style={{ borderColor: "var(--bet-fusion-shadow-borders)", margin: "20px 0" }} />

                    {/* Responsible Gambling */}
                    <Title
                        level={5}
                        style={{ color: "var(--footer-color)", display: "flex", alignItems: "center", gap: 8 }}
                    >
                        <ExclamationCircleOutlined style={{ color: "var(--secondary)" }} />
                        Responsible Gambling
                    </Title>
                    <Paragraph style={{ color: "var(--footer-links)", fontSize: 12, lineHeight: 1.6 }}>
                        ...
                        <Link to="tel:0718111117" target="_blank" style={{ color: "var(--blue)" }}>
                            0718111117
                        </Link>
                        {" | "}
                        <Link to="tel:0718111119" target="_blank" style={{ color: "var(--blue)" }}>
                            0718111119
                        </Link>{" "}
                        or{" "}
                        <Link to="/responsible-gambling" style={{ color: "var(--blue)" }}>
                    ...
                    <Title
                        ...
                        style={{ color: "var(--footer-color)", display: "flex", alignItems: "center", gap: 8 }}
                    >
                        <FileTextOutlined style={{ color: "var(--blue)" }} />
                        Legal
                    </Title>
                    <Space wrap size={[24, 8]} style={{ marginBottom: 8 }}>
                        {[
                            ...
                            <Link
                                key={l.to}
                                to={l.to}
                                style={{ color: "var(--footer-links)", fontSize: 13, textDecoration: "none" }}
                                onMouseEnter={(e) => (e.target.style.color = "var(--blue)")}
                                onMouseLeave={(e) => (e.target.style.color = "var(--footer-links)")}
                            >
                                {l.label}
                            </Link>
                        ))}
                    ...
                    >
                        <StopOutlined style={{ color: "var(--bet-fusion-red)", fontSize: 16 }} />
                        <b style={{ color: "var(--footer-color)", whiteSpace:'nowrap' }}>Betfusion</b> does not support underage gambling.
                    ...
                    {/* Social */}
                    <Title level={5} style={{ textAlign: "center", color: "var(--footer-color)" }}>
                        Follow Us
                    </Title>
                            ...
                            <Col key={idx}>
                                ...
                                >
                                    <Space direction="vertical" align="center">
                                        ...
                                        <Text style={{ fontSize: 11, color: "var(--footer-links)" }}>{item.label}</Text>
                                    </Space>
                                </Link>
                            </Col>
                        ))}
                    ...
                    <Paragraph style={{ textAlign: "center", fontSize: 12, color: "var(--footer-links)", marginTop: 8 }}>
