      ...
      <Row justify="center">
        <Col span={24} style={{ maxWidth: 960, margin: "0 auto" }}>
          ...
          <Paragraph style={{ color: "#64748b", fontSize: 12, lineHeight: 1.6 }}>
            ...
            <Link to="tel:0718111117" target="_blank" style={{ color: "#fb8603" }}>
              0718111117
            </Link>
            {" | "}
            <Link to="tel:0718111119" target="_blank" style={{ color: "#fb8603" }}>
              0718111119
            </Link>{" "}
            or{" "}
            <Link to="/responsible-gambling" style={{ color: "#fb8603" }}>
          ...
          <Title
            ...
            style={{ color: "#f8fafc", display: "flex", alignItems: "center", gap: 8 }}
          >
            <FileTextOutlined style={{ color: "#fb8603" }} />
            Legal
          </Title>
          <Space wrap size={[24, 8]} style={{ marginBottom: 8 }}>
            {[
              ...
              <Link
                ...
                onMouseEnter={(e) => (e.target.style.color = "#fb8603")}
