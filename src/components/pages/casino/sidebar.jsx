...
// Added inline styling to NavItem to automatically use theme variables
...
const Sidebar = ({ mobileOpen = false, onMobileClose }) => {
    ...
    return (
        <>
            ...
            {/*
        Injecting the background and border variables into the main aside container
        so it flawlessly switches between dark and light themes.
      */}
            <aside
                className={rootClass}
                style={{
                    background: "var(--bet-fusion-side-bg)",
                }}
            >
            ...
            {collapsed ? icons.chevronRight : icons.chevronLeft}
                ...
                <nav className="sidebar-nav">
                    <div className="sidebar-section-title" style={{ color: "var(--grey)" }}>CASINO</div>
                    ...
                    <NavItem
                        to="/casino?categoryId=Live Casino"
                        active={path.includes("categoryId=Live Casino")}
                        label="Live Casino"
                        icon={icons.live}
                    ...
                    <NavItem to="/casino?categoryId=numbers" active={path.includes("categoryId=game-shows")} label="Game Shows" icon={icons.gameShows} />

                    <div className="sidebar-divider"  />

                    {/* Contact Support Item explicitly themed */}
                    <a href="tel:0711156430" className="sidebar-nav-item sidebar-support-item" style={{ color: "var(--grey)", textDecoration: "none" }}>
