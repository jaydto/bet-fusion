                ...
                <div className="home" style={{margin:"auto", maxWidth:"991px"}}>
                        <div className="homepage">
                            ...
                            <div className="col-md-12 mt-2 text-white p-2 ">
                                <p>
                                    CrashKali uses cookies on our website. By using our services, you consent to the use
                                    of
                            ...
                            <div className="col-md-12 mt-2 text-white accordion-container">
                                <Accordion allowMultipleExpanded={false} allowZeroExpanded={true}>
                                    ...
                                    <AccordionItem>
                                        ...
                                        <AccordionItemPanel className='accordion-item-panel'>
                                            <p>
                                                CrashKali uses cookies to enable certain functions of the service, to
                                                provide
