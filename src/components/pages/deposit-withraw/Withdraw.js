        ...
        return (
            <React.Fragment>
                ...
                <div style={{height: '100vh', background: '#16202C'}}>
                    <div className={``}>
                        <Navbar expand="md"
                                className="mb-0 ck pc os app-navbar top-nav top-nav-centric top-section-page"
                                fixed="top" variant="dark" style={{paddingLeft: '0px', paddingBottom: '0px'}}>
                            <Container fluid
                                       className={'d-flex justify-content-between mobile-change top-login-background-img'}>
                                <Navbar.Brand className="e logo align-self-start menu-control d-flex w-100 "
                                              title="Betnare" style={{paddingLeft: '0px', paddingBottom: '0px'}}>
                                ...
                                <Navbar.Offcanvas
                                    ...
                                    <Offcanvas.Header closeButton className='text-white' closeVariant={"white"}>
                                        <Offcanvas.Title id={`offcanvasNavbarLabel-expand-${expand}`}>
                                            <div className="col-3">
                                                <div>
                                                    <LazyLoadImage src={logo} alt="Betnare" title="Betnare"
                                                                   effects="blur"/>
                                                </div>
                                            </div>
                                        </Offcanvas.Title>
                            ...
                            <div className="d-flex flex-column justify-content-between h-100 px-4"
                                ...
                                <Row justify="center">
                                    <Col xs={0} sm={0} md={0} lg={20}>
                                        ...
                                        <h1 className="text-white text-center" style={{fontSize: "30px"}}>Withdraw Cash
                                            From Your Account</h1>
