                                ...
                                <Tabs
                                    ...
                                    <Tab eventKey="matches" title="Matches" className={'background-primary shadow p-5'}
                                        ...
                                        <div className="col-md-12 mt-5 text-center">
                                            ...
                                            <PDFDownloadLink
                                                className={`btn btn-warningbetfusion-button-bg text-dark btn-lg p-4 col-md-4 ${loaded ? '' : 'disabled'}`}
                                        ...
                                        <div className="col mt-5 background-primary">
                                            <Card className={'background-primary text-white'}>
                                                ...
                                                <Card.Body>
                                                    ...
                                                    <PDFDownloadLink
                                                        className={`btn btn-warningbetfusion-button-bg text-white btn-lg p-4 col-md-4 ${loaded ? '' : 'disabled'}`}
                                                        document={<PdfDocument matches={matches} jackpot={isJackpot}
                                                                               title={title}/>}
                                                        fileName="matches.pdf">
                                                        {({blob, url, loading, error}) =>
