...
import { faAngleLeft, faAngleRight, faHome, faSquareCaretLeft, faSquareCaretRight } from "@fortawesome/free-solid-svg-icons";
  ...
  return (
    <div className="games-page d-flex">
      <div class="left-nav lazyloaded">
        ...
        >
          <div class="scroll-content mb-3">
              ...
              <div id="v-game-filters">
                <div class="sideFilters" data-v-72be8539="">
                  ...
                  <div class="filtersContainer" data-v-72be8539="">
                    ...
                    <div class="filter-action filter-item" data-v-72be8539="">
                      <i class="ico ico-radio"></i> ROULETTE PLAY
                    </div>
                    <div class="filter-action filter-item" data-v-72be8539="">
                      <i class="ico ico-radio"></i> BLACKJACK
                    </div>
                    <div class="filter-action filter-item" data-v-72be8539="">
                      <i class="ico ico-radio"></i> CARD PLAY
                    </div>
                    <div class="filter-action filter-item" data-v-72be8539="">
                      <i class="ico ico-radio"></i> VIDEO POKER
                    </div>
                    <div class="filter-action filter-item" data-v-72be8539="">
                      <i class="ico ico-radio"></i> LIVE CASINO
                    </div>
                    <div class="filter-action filter-item" data-v-72be8539="">
                      <i class="ico ico-radio"></i> EXCLUSIVE
                    </div>
                    <div class="filter-action filter-item" data-v-72be8539="">
                      <i class="ico ico-radio"></i> POPULAR
                    </div>
                    <div class="filter-action filter-item" data-v-72be8539="">
                      <i class="ico ico-radio"></i> NEW
                    </div>
                    <div class="filter-action filter-item" data-v-72be8539="">
                      <i class="ico ico-radio"></i> DAILY JACKPOT
                    </div>
                    <div class="filter-action filter-item" data-v-72be8539="">
                      <i class="ico ico-radio"></i> LIVE GAME SHOWS
                    </div>
                    <div class="filter-action filter-item" data-v-72be8539="">
                      <i class="ico ico-radio"></i> JACKPOT
                    </div>
                    {/* <div class="filter-action filter-item" data-v-72be8539="">
                      <i class="ico ico-radio"></i> SCRATCH PLAY
                    </div> */}
                    {/* <div class="filter-item" data-v-72be8539="">
                      STAR RATING{" "}
                      <i class="ico ico-chevron-right" data-v-72be8539=""></i>
            ...
            <div class="menu-item not-active">
              <a href="/favorites/">
                <i class="ico ico-kickers"></i>Favorites{" "}
                <i class="ico ico-chevron-right"></i>
              </a>
            </div>
            <div class="menu-item not-active">
              <a href="/hot/">
                <i class="ico ico-specials"></i>Hot{" "}
                <i class="ico ico-chevron-right"></i>
              </a>
            </div>
            <div class="menu-item not-active">
              <a href="/about/">
                <i class="ico ico-about"></i>Popular
                <i class="ico ico-chevron-right"></i>
              </a>
            </div>
            <div class="menu-item not-active">
      ...
      <div className="right-body ">
        ...
        <section
          className={`section-container ${!showFilters ? "d-flex" : "d-none"}`}
          id="v-search"
        >
