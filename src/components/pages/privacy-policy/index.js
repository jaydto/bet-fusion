                ...
                >
                  <AccordionItem uuid={preExpandedItems[0]}>
                    ...
                    <AccordionItemPanel className="accordion-item-panel">
                      <p>
                        1.1.At BetDonjo we are committed to protecting and
                        ...
                        with the 
                        {<Link to="/terms-and-conditions"> BetDonjo General Terms and Conditions </Link>} ("Terms and Conditions").
                      </p>
                    </AccordionItemPanel>
                  </AccordionItem>
                  <AccordionItem uuid={preExpandedItems[1]}>
                    ...
                    <AccordionItemPanel className="accordion-item-panel">
                      ...
                      <p>
                        2.3. 3.	"Channel(s)" means the BetDonjo website, mobile app, social media platforms and any other platforms used to offer the BetDonjo Services;
                      </p>
                      <p>
                        2.4. 4.	"Customer(s)" means registered users of the BetDonjo Service;
                      </p>
                      <p>
                        2.5. 
5.	"Data Protection Laws" means the Data Protection Act, 2019, as amended and "Local Data Protection Laws" shall be construed accordingly;
                  ...
                  <AccordionItem uuid={preExpandedItems[2]}>
                    ...
                    <AccordionItemPanel className="accordion-item-panel">
                      ...
                      <p>
                        3.2. 	A reference to "We" "Us" "Our" is a reference to Shop and Deliver Limited, BetDonjo and or its successors in title and assigns.  </p>
                    </AccordionItemPanel>
                  </AccordionItem>
                  <AccordionItem uuid={preExpandedItems[3]}>
                    ...
                    We collect your Personal Data when you interact with us or use our Services in any of the following ways (this list is subject to amendment from time to time as per clause 19 below):
                      ...
                      <p>
                        4.1. 	Visit, access or use any of the BetDonjo Services, events, business premises and / or Channels;
                      </p>
                      ...
                      <p>
                        4.1.3.	Participate in any of BetDonjo’s platforms, for example discussion boards on our website or social media platforms, promotions or surveys, report a problem with our mobile app, website, Services or products, or ask for more information on a Service or product;
                      </p>
                      <p>
                        4.1.4.	Interact with us as a supplier, agent, merchant, or dealer of BetDonjo Services; and
                      </p>
                      <p>
                  ...
                  <AccordionItem uuid={preExpandedItems[4]}>
                    ...
                    We may collect, use, and store different kinds of Personal Data about you, which we have grouped together as follows:
                      ...
                      <ol>
                        ...
                        <li>
                        3.	Financial Information - includes your transaction information when you withdraw from or deposit into your BetDonjo account, information we obtain from fraud prevention agencies, Anti-Money Laundering agencies and any government regulator;
                        </li>
                        <li>
                  ...
                  <AccordionItem uuid={preExpandedItems[7]}>
                    ...
                    <AccordionItemPanel className="accordion-item-panel">
                      ...
                      <p>
                        Through your interaction with any of the BetDonjo Services, premises, or our Channels, we may collect Sensitive Personal Data about you to the extent that the same is necessary for the full and proper operation of the BetDonjo Services that we offer to you
                  ...
                  <AccordionItem uuid={preExpandedItems[8]}>
                    ...
                    <AccordionItemPanel className="accordion-item-panel">
                      ...
                      <ul>
                        ...
                        <li>
                        2.	Authorized or consented by you for any reason, including for the purposes of carrying out any obligation to you under an agreement with BetDonjo; or
                        </li>
                        <li>
...
<ul>
  ...
  <li>2.	our subsidiaries, associates, partners, merchants, or agents who are involved in delivering BetDonjo products and Services you subscribe to or use;</li>
  ...
  <li>6.	survey agencies that conduct surveys on behalf of BetDonjo; and</li>
                  ...
                  <AccordionItem uuid={preExpandedItems[13]}>
                    ...
                    <AccordionItemPanel className="accordion-item-panel">
                      ...
                      <ol className="list-count-type">
                        ...
                        <li>
                        4.	inform BetDonjo of any changes that occur in your Personal Data to facilitate maintenance of accurate and up-to-date records;
                        </li>
                        <li>
                  ...
                  <AccordionItem uuid={preExpandedItems[14]}>
                    ...
                    <AccordionItemPanel className="accordion-item-panel ">
                      ...
                      <ul>
                        <li>
                          {" "}
                          BetDonjo reserves the right to terminate any agreement with you for failure to comply with the provisions of this Privacy Policy and its {<a href="/terms-and-conditions">Terms and Conditions</a> }
