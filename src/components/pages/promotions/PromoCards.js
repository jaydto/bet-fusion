  ...
  return (
    <div className="col px-4">
      ...
      >
        ...
        <div className="col-md-2 promo-styling shadow-lg promotion">
          <div className="d-flex flex-column promo-inner">
            <img src={'https://storage.googleapis.com/nareimages/carousel/SpaceMan.webp'} className={"rounded promo-image "} />
            <h5
                className="bold d-flex justify-content-center h4 pt-2"
                style={{ color: "#ea5d0b" }}
            >
        ...
        <div className="col-md-2 promo-styling shadow-lg promotion">
          <div className="d-flex flex-column promo-inner">
            <img src={'https://storage.googleapis.com/nareimages/carousel/Aviator.webp'} className={"rounded promo-image "} />
            <h5
                className="bold d-flex justify-content-center h4 pt-2"
                style={{ color: "#ea5d0b" }}
            >
        ...
        <div className="col-md-2 promo-styling shadow-lg promotion">
          <div className="d-flex flex-column promo-inner">
            <img src={'https://storage.googleapis.com/nareimages/smartsoft/jetx.png'} className={"rounded promo-image "} />
            <h5
                className="bold d-flex justify-content-center h4 pt-2"
                style={{ color: "#ea5d0b" }}
            >
            ...
            <p className="container mx-1 px-2">
              Predict which multiplier the plane will crash. The longer the plane flies, the higher the multiplier
            </p>
            <hr/>
            <div className="d-flex justify-content-between my-2 mx-2">
              <button className={"profile-button border-0 h-25 rounded promo-button"}
                      style={{background:"#ea5d0b"}}
                      onClick={()=>navigate(`/smart-play?game=JetX&category=JetXr`)}>Play JetX</button>
              <div
                  className={"  h-25 border-0 bg-transparent"}
                  style={{ color: "#ea5d0b" }}
                  onClick={()=> {
        ...
        <div className="col-md-2 promo-styling card d-flex flex-row shadow-lg mt-2 promotion d-none">
          <div className="col-md-12 promo-inner">
            <div className="d-flex flex-column">
              ...
              <hr/>
              <div className="d-flex justify-content-between my-2 mx-2">
                 <button className={"profile-button border-0 h-25 rounded promo-button"} style={{background:"#ea5d0b"}}>Bet Now</button>
                <div
                  className={"  h-25 border-0 bg-transparent"}
                  style={{ color: "#ea5d0b" }}
