        ...
        <div className="col-md-12 mt-2 text-white accordion-container">
            ...
            <Accordion allowMultipleExpanded={true} allowZeroExpanded preExpanded={['1']}>
                ...
                <AccordionItem>
                    <AccordionItemHeading>
                        <AccordionItemButton className={"accordion-button"}>
                            <span className="text-uppercase">HOW TO PLAYjazabets Milli Daily Jackpot</span>
                        </AccordionItemButton>
                    </AccordionItemHeading>
                    <AccordionItemPanel className={'accordion-item-panel'}>
                ...
                <AccordionItem>
                    <AccordionItemHeading>
                        <AccordionItemButton className={"accordion-button"}>
                            GENERALjazabets DAILY JACKPOT TERMS AND CONDITIONS
                        </AccordionItemButton>
                    </AccordionItemHeading>
                    <AccordionItemPanel className={'accordion-item-panel'}>
                        ...
                        <ul>
                            ...
                            <li>
                               jazabets  Milli Daily Jackpot is based on ELEVEN (11) pre-selected Soccer games
                        ...
                        <ol>
                            ...
                            <li>Where a Daily Jackpot game is cancelled, an official public draw shall be carried out
                                ...
                                cancelled, interrupted, abandoned, suspended or postponed,jazabets may at its
                                discretion,
                            ...
                            <li>With the guidance of the BCLB,jazabets reserves the right to amend the terms and
                                conditions
                                of the Daily Jackpot at any time, for any reason and without notice.
                            </li>
                            <li>Employees ofjazabets, their relatives, agents or the agent’s relatives are not eligible
                                to
                                win prizes.
                            </li>

                        </ol>
                        <p><strong>Generaljazabets Terms and Conditions, Privacy and Responsible Gaming policies
                            apply.</strong></p>
                ...
                <AccordionItem>
                    <AccordionItemHeading>
                        <AccordionItemButton className={"accordion-button"}>
                           jazabets  Milli Daily Jackpot Bonuses
                        </AccordionItemButton>
                    </AccordionItemHeading>
                    <AccordionItemPanel className={'accordion-item-panel'}>
                        <ul>
                            ...
                            <li>
                                II.	Where ONE (1) or MORE games are CANCELLED, INTERRUPTED, ABANDONED, SUSPENDED or POSTPONED,jazabets may at its discretion, AWARD the Jackpot BET ID with the highest correct predictions within 48 hours of CANCELLATION or REFUND ALL STAKES collected on the SPECIFIC JACKPOT.
                            </li>
                            <li>
                                III.	<b>ZERO out of ELEVEN outcomes</b> - In an instance THAT a player gets 0/11 CORRECT predictions on the Running Jackpot, they automatically get a (FREE TICKET) onto the next availablejazabets Daily Jackpot. This Offer is ONLY available to players who get ZERO out of the ELEVEN available jackpot games to play from.
                            </li>
                            <li>
                        ...
                        <ul>
                            ...
                            <li>
                               jazabets will also award the Player with the highest Correct predictions randomly.
                            </li>
                        </ul>
                    </AccordionItemPanel>
                </AccordionItem>
