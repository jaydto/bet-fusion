        ...
        <div className="col-md-12 mt-2 text-white accordion-container">
            ...
            <Accordion allowMultipleExpanded={true} allowZeroExpanded preExpanded={['1']}>
                ...
                <AccordionItem>
                    <AccordionItemHeading>
                        <AccordionItemButton className={"accordion-button"}>
                            <span className="text-uppercase">HOW TO PLAY BetDonjo Milli Daily Jackpot</span>
                        </AccordionItemButton>
                    </AccordionItemHeading>
                    <AccordionItemPanel className={'accordion-item-panel'}>
                        <p>The BetDonjo Jackpot is a pool betting platform that is promoted and operated by BetDonjo on
                            pre-selected football matches. The BetDonjo Daily Jackpot competition consists of predicting
                            results of 11 matches which are selected by BetDonjo Daily. </p>
                        <p>To take part and have a chance to win the BetDonjo jackpot you must get registered on
                            www.BetDonjo.com and have at least KES20/= in your BetDonjo account. If you correctly predict
                ...
                <AccordionItem>
                    <AccordionItemHeading>
                        <AccordionItemButton className={"accordion-button"}>
                            GENERAL BetDonjo DAILY JACKPOT TERMS AND CONDITIONS
                        </AccordionItemButton>
                    </AccordionItemHeading>
                    <AccordionItemPanel className={'accordion-item-panel'}>
                        ...
                        <p>The BetDonjo Daily Jackpot prize money is KES 1,000,000/=</p>
                        ...
                        <ul>
                            ...
                            <li>
                                BetDonjo  Milli Daily Jackpot is based on ELEVEN (11) pre-selected Soccer games
                            ...
                            <li>
                                To make your selections- On the BetDonjo Daily Jackpot competition entry page
                        ...
                        <ol>
                            ...
                            <li>Where a Daily Jackpot game is cancelled, an official public draw shall be carried out
                                ...
                                cancelled, interrupted, abandoned, suspended or postponed, BetDonjo may at its
                                discretion,
                                cancel the Daily Jackpot and refund the stake placed within 48 hours of cancellation.
                            </li>
                            <li>Winners shall be required to avail themselves in the BetDonjo offices with proof of
                                identity
                            ...
                            <li>The period for claiming the prize is seven (7) days failure to which BetDonjo may deem
                                the
                                prize forfeited, unless the period is extended at the sole discretion of BetDonjo.
                            </li>
                            ...
                            <li>With the guidance of the BCLB, BetDonjo reserves the right to amend the terms and
                                conditions
                                of the Daily Jackpot at any time, for any reason and without notice.
                            </li>
                            <li>Employees of BetDonjo, their relatives, agents or the agent’s relatives are not eligible
                                to
                                win prizes.
                            </li>

                        </ol>
                        <p><strong>General BetDonjo Terms and Conditions, Privacy and Responsible Gaming policies
                            apply.</strong></p>
                ...
                <AccordionItem>
                    <AccordionItemHeading>
                        <AccordionItemButton className={"accordion-button"}>
                            BetDonjo  Milli Daily Jackpot Bonuses
                        </AccordionItemButton>
                    </AccordionItemHeading>
                    <AccordionItemPanel className={'accordion-item-panel'}>
                        <ul>
                            ...
                            <li>
                                II.	Where ONE (1) or MORE games are CANCELLED, INTERRUPTED, ABANDONED, SUSPENDED or POSTPONED, BetDonjo may at its discretion, AWARD the Jackpot BET ID with the highest correct predictions within 48 hours of CANCELLATION or REFUND ALL STAKES collected on the SPECIFIC JACKPOT.
                            </li>
                            <li>
                                III.	<b>ZERO out of ELEVEN outcomes</b> - In an instance THAT a player gets 0/11 CORRECT predictions on the Running Jackpot, they automatically get a (FREE TICKET) onto the next available BetDonjo Daily Jackpot. This Offer is ONLY available to players who get ZERO out of the ELEVEN available jackpot games to play from.
                            </li>
                            <li>
                            ...
                            <li>
                                V.	<b>TEN OUT OF ELEVEN outcomes</b> - BetDonjo Jackpot contains 11 games, the Jackpot bonuses are from 10 correct games. The Jackpot bonus amount shall vary between the Jackpot Bonuses. The prize allocated to the Bonus winners is completely at BetDonjo’s discretion. Any Jackpot Bonus shall be divided equally among the Jackpot bonus winners if there is more than ONE winner within the respective class.
                            </li>
                        </ul>
                        <h4>
                            BetDonjo  MILLI DAILY JACKPOT
                        ...
                        <ul>
                            ...
                            <li>
                                BetDonjo will also award the Player with the highest Correct predictions randomly.
                            </li>
                        </ul>
                    </AccordionItemPanel>
                </AccordionItem>
