        ...
        <div className="col-md-12 mt-2 text-white accordion-container">
            ...
            <Accordion allowMultipleExpanded={true} allowZeroExpanded preExpanded={['1']}>
                ...
                <AccordionItem>
                    <AccordionItemHeading>
                        <AccordionItemButton className={"accordion-button"}>
                            <span className="text-uppercase">HOW TO PLAY BetNare Half a Milli Daily Jackpot</span>
                        </AccordionItemButton>
                    </AccordionItemHeading>
                    <AccordionItemPanel className={'accordion-item-panel'}>
                        <p>The BetNare Jackpot is a pool betting platform that is promoted and operated by BetNare on pre-selected football matches.</p>
                        <p>The BetNare Daily Jackpot competition consists of predicting results of 11 matches which are selected by BetNare Daily. </p>
                        ...
                        <p>To take part and have a chance to win the BetNare jackpot you must get registered on www.betnare.com and have at least KES10/= in your BetNare account. If you correctly predict all the 11 match results, you win the Daily Jackpot prize of Kshs 500,000/=
                ...
                <AccordionItem>
                    ...
                    <AccordionItemPanel className={'accordion-item-panel'}>
                        <p> Matches will be settled on the official results after 90 minutes on play, including injury time. Extra time and penalty shoot-outs shall not be included.</p>
                        <p>The competitions are open to persons aged 18 years or over, resident in Kenya. Proof of age and identity are a MUST requirement.</p>
                        <p>The BetNare Daily Jackpot prize money is KES 500,000/=</p>
                        <p>Players will be deemed to have accepted these terms and conditions and agreed to be bound by them when entering this competition.</p>
                        ...
                        <ul>
                            ...
                            <li>
                                BetNare Half a Milli Daily Jackpot is based on ELEVEN (11) pre-selected Soccer games with HUGE Guaranteed bonuses starting from TEN (10) Correct predictions and ZERO (0) Correct predictions.
                            ...
                            <li>
                                To make your selections- On the BetNare Daily Jackpot competition entry page (www.betnare.com/jackpot) make your predictions on the 11 pre-selected football matches (HOME WIN, DRAW, AWAY WIN). The stake amount of each combination is KES 10/=.
                            </li>
                            <li>
                                <strong>NOTE;</strong>&nbsp;BETNARE DOESNOT ACCEPT DOUBLE CHANCE COMBINATION ON THE JACKPOT.
                            </li>
                            <li>
                                You CANNOT make more than 1 prediction for ONE match.
                            </li>
                            <li>
                                The Daily Jackpot bet can be placed by submitting predictions of the results of 11 pre-selected football matches at (www.betnare.com/jackpot) or through
                            </li>
                            <ul>
                                <li>
                                ...
                                <li>
                                    b)	By choosing “Auto Bet” option, a random selection of one prediction per match will be automatically selected with a fixed stake of KES 10/=.
                                </li>
                            </ul>
                        </ul>
