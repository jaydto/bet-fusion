            ...
            <Accordion allowMultipleExpanded={true} allowZeroExpanded preExpanded={['1']}>
                ...
                <AccordionItem>
                    <AccordionItemHeading>
                        <AccordionItemButton className={"accordion-button"}>
                            <span className="text-uppercase">HOW TO PLAY CrashKali Milli Daily Jackpot</span>
                        </AccordionItemButton>
                    </AccordionItemHeading>
                    <AccordionItemPanel className={'accordion-item-panel'}>
                        <p>The CrashKali Jackpot is a pool betting platform that is promoted and operated by CrashKali on
                            pre-selected football matches. The CrashKali Daily Jackpot competition consists of predicting
                            results of 11 matches which are selected by CrashKali Daily. </p>
                        <p>To take part and have a chance to win the CrashKali jackpot you must get registered on
                            www.CrashKali.com and have at least KES20/= in your CrashKali account. If you correctly predict
                ...
                <AccordionItem>
                    ...
                    <AccordionItemPanel className={'accordion-item-panel'}>
                        ...
                        <p>CrashKali may, at its own discretion, introduce a Jackpot rollover, in which jackpot totals
                ...
                <AccordionItem>
                    <AccordionItemHeading>
                        <AccordionItemButton className={"accordion-button"}>
                            GENERAL CrashKali DAILY JACKPOT TERMS AND CONDITIONS
                        </AccordionItemButton>
                    </AccordionItemHeading>
                    <AccordionItemPanel className={'accordion-item-panel'}>
                        ...
                        <p>The CrashKali Daily Jackpot prize money is KES 1,000,000/=</p>
                        ...
                        <ul>
                            ...
                            <li>
                                CrashKali  Milli Daily Jackpot is based on ELEVEN (11) pre-selected Soccer games
                            ...
                            <li>
                                To make your selections- On the CrashKali Daily Jackpot competition entry page
                                (www.CrashKali.com/jackpot) make your predictions on the 11 pre-selected football matches
                                (HOME WIN, DRAW, AWAY WIN). The stake amount of each combination is KES 20/=.
                            </li>
                            <li>
                                <strong>NOTE;</strong>&nbsp;CrashKali DOES NOT ACCEPT DOUBLE CHANCE COMBINATION ON THE
                                JACKPOT.
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                pre-selected football matches at (www.CrashKali.com/jackpot) or through
                            </li>
                            <ul>
                                <li>
                        ...
                        <ol>
                            ...
                            <li>Where a Daily Jackpot game is cancelled, an official public draw shall be carried out
                                ...
                                cancelled, interrupted, abandoned, suspended or postponed, CrashKali may at its
                                discretion,
                                cancel the Daily Jackpot and refund the stake placed within 48 hours of cancellation.
                            </li>
                            <li>Winners shall be required to avail themselves in the CrashKali offices with proof of
                                identity
                                before any payment is made.
                            </li>
                            <li>CrashKali reserves the right to verify, with the relevant authorities, any identification
                                document presented, before making any payment.
                            </li>
                            <li>The period for claiming the prize is seven (7) days failure to which CrashKali may deem
                                the
                                prize forfeited, unless the period is extended at the sole discretion of CrashKali.
                            </li>
                            <li>CrashKali reserves the right to withhold up to 90% of any prize share until the
                                presentation
                                day.
                            </li>
                            <li>CrashKali reserves the right to pay the whole amount of any prize share to a winner by
                                cheque
                                or bank transfer.
                            </li>
                            <li>CrashKali’s decision is final and legally binding on all entrants in relation to all
                                aspects of
                                the competition including (without limitation) allocation of the prizes and no
                                correspondence will be entered into.
                            </li>
                            <li>With the guidance of the BCLB, CrashKali reserves the right to amend the terms and
                                conditions
                                of the Daily Jackpot at any time, for any reason and without notice.
                            </li>
                            <li>Employees of CrashKali, their relatives, agents or the agent’s relatives are not eligible
                                to
                                win prizes.
                            </li>

                        </ol>
                        <p><strong>General CrashKali Terms and Conditions, Privacy and Responsible Gaming policies
                            apply.</strong></p>
                ...
                <AccordionItem>
                    <AccordionItemHeading>
                        <AccordionItemButton className={"accordion-button"}>
                            CrashKali  Milli Daily Jackpot Bonuses
                        </AccordionItemButton>
                    </AccordionItemHeading>
                    <AccordionItemPanel className={'accordion-item-panel'}>
                        <ul>
                            ...
                            <li>
                                II.	Where ONE (1) or MORE games are CANCELLED, INTERRUPTED, ABANDONED, SUSPENDED or POSTPONED, CrashKali may at its discretion, AWARD the Jackpot BET ID with the highest correct predictions within 48 hours of CANCELLATION or REFUND ALL STAKES collected on the SPECIFIC JACKPOT.
                            </li>
                            <li>
                                III.	<b>ZERO out of ELEVEN outcomes</b> - In an instance THAT a player gets 0/11 CORRECT predictions on the Running Jackpot, they automatically get a (FREE TICKET) onto the next available CrashKali Daily Jackpot. This Offer is ONLY available to players who get ZERO out of the ELEVEN available jackpot games to play from.
                            </li>
                            <li>
                            ...
                            <li>
                                V.	<b>TEN OUT OF ELEVEN outcomes</b> - CrashKali Jackpot contains 11 games, the Jackpot bonuses are from 10 correct games. The Jackpot bonus amount shall vary between the Jackpot Bonuses. The prize allocated to the Bonus winners is completely at CrashKali’s discretion. Any Jackpot Bonus shall be divided equally among the Jackpot bonus winners if there is more than ONE winner within the respective class.
                            </li>
                        </ul>
                        <h4>
                            CrashKali  MILLI DAILY JACKPOT
                        ...
                        <ul>
                            ...
                            <li>
                                CrashKali will also award the Player with the highest Correct predictions randomly.
                            </li>
                        </ul>
                    </AccordionItemPanel>
                </AccordionItem>
