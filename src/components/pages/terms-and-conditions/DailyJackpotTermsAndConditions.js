            ...
            <Accordion allowMultipleExpanded={true} allowZeroExpanded preExpanded={['1']}>
                ...
                <AccordionItem>
                    ...
                    <AccordionItemPanel className={'accordion-item-panel'}>
                        ...
                        <p>Betfusion may, at its own discretion, introduce a Jackpot rollover, in which jackpot totals
                ...
                <AccordionItem>
                    ...
                    <AccordionItemPanel className={'accordion-item-panel'}>
                        ...
                        <ul>
                            ...
                            <li>
                                <strong>NOTE;</strong>&nbsp;Betfusion DOES NOT ACCEPT DOUBLE CHANCE COMBINATION ON THE
                                JACKPOT.
                            </li>
                            <li>
                        ...
                        <ol>
                            ...
                            <li>Betfusion reserves the right to pay the whole amount of any prize share to a winner by
                                cheque
                                or bank transfer.
                            </li>
                            <li>Betfusion’s decision is final and legally binding on all entrants in relation to all
                                aspects of
