        ...
        <AccordionItem>
            ...
            <AccordionItemPanel className='accordion-item-panel'>
                ...
                <ol>
                    ...
                    <li> "Game" refers any gaming activity presented by BetNare on its Internet Sites and Mobile
                    ...
                    <li> "Internet Site", "Website" or "Site" shall mean the Internet Websites www.betnare.com and all
                    ...
                    <li>"Login and Password" means the login and password details that are automatically generated
                        and/or chosen by a player upon registering with BETNARE.
                    </li>
                    ...
                    <li> "Service" shall include all betting services and game offer activities related to it and listed
                        on www.betnare.com including but not limited to online jackpot, live play, pre-match,
                    ...
                    <li>"Us, We" or "BETNARE " means Beyond Intoch Software Limited.</li>
                    ...
                    <li> “Header” the BetNare header that provides quick access to your bet slip, "My bets", account
                        options and the Cashier
                    </li>
                    <li>
                        “Highlights” events that most of BetNare users have bet on. These are the most-popular events.
                    </li>
                    <li>
                    ...
                    <li>
                        “Navigation bar” this is the main navigation bar located below the BetNare header. It enables
