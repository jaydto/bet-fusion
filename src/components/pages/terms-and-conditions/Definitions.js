        ...
        <AccordionItem>
            ...
            <AccordionItemPanel className='accordion-item-panel'>
                ...
                <ol>
                    ...
                    <li> "Game" refers any gaming activity presented by CrashKali on its Internet Sites and Mobile
                    ...
                    <li> "Internet Site", "Website" or "Site" shall mean the Internet Websites www.CrashKali.com and all
                    ...
                    <li>"Login and Password" means the login and password details that are automatically generated
                        and/or chosen by a player upon registering with CrashKali.
                    </li>
                    ...
                    <li> "Service" shall include all betting services and game offer activities related to it and listed
                        on www.CrashKali.com including but not limited to online jackpot, live play, pre-match,
                    ...
                    <li>"Us, We" or "CrashKali " means Beyond Intoch Software Limited.</li>
                    ...
                    <li>
                        “Navigation bar” this is the main navigation bar located below the CrashKali header. It enables
