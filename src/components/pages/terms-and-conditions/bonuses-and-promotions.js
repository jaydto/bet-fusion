            ...
            <AccordionItemPanel className='accordion-item-panel'>
                <ol>
                    <li>
                        ...
                        The amount of Bonus Money is determined bybetfusion and set out on the website.
                    </li>

                    <li>The CLIENT binds himself not to abuse the ability of opening accounts in order to benefit from bonus credits and other promotional offers that may be offered. The company reserves the right, in case of abusive behavior on the CLIENT’S part as related to bonus credits and/or to promotional offers bybetfusion, to rescind or block
                        CLIENT accounts created to that end, as well as their transactions.</li>
                    <li>Betfusion reserves the right to revoke and/or cancel any bonus and/or promotional winnings which are deemed to have occurred due to abuse and/or misuse of any promotional system.
                ...
                <ol>
                    ...
                    <li>
                        Ifbetfusion notices something suspicious about your activities with the bonus, then we may
                        take it away. This includes very similar betting patterns between the referrer and the referred
                        account.
                    </li>
                    <li>
                       betfusion bonus has no expiry.
                    </li>

                </ol>
                <br/>
                <strong className="text-decoration-underline">Betfusion Bonus Rules</strong>
                <br/>
                <ol>
                    <li>
                ...
                <p><strong><strong>NB;</strong>betfusion has the right to amend the terms of the offer, cancel or renew the offer, or refuse to allow participation at any time without prior notice.
...
Ifbetfusion believes itself to be the victim of fraud or money laundering, the company has the right to close customers' accounts and freeze the remaining balance.</strong></p>
