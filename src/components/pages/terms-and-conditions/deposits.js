                ...
                <ol>
                    ...
                    <li>
                       jazabets reserves the right to impose certain conditions on the use
                        ...
                        suspicious activity of the particular player.jazabets retains the
                        right
                        to change the payment methods available.
                    </li>
                    <li>
                       jazabets does not guarantee that all methods of payment are available
                    ...
                    <li>
                       jazabets reserves the right to request further information and
                        ...
                        entitlement to the balance by some other means.jazabets reserves the
