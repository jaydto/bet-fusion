        ...
        <AccordionItem>
            ...
            <AccordionItemPanel className='accordion-item-panel'>
                <ol>
                    ...
                    <li>
                        BetDonjo reserves the right to impose certain conditions on the use
                        of
                        ...
                        suspicious activity of the particular player. BetDonjo retains the
                        right
                        to change the payment methods available.
                    </li>
                    <li>
                        BetDonjo does not guarantee that all methods of payment are available
                    ...
                    <li>
                        BetDonjo reserves the right to request further information and
                        ...
                        entitlement to the balance by some other means. BetDonjo reserves the
                    ...
                    {/*</li>*/}
                    <li>
                        The player acknowledges that BetDonjo reserves the right to request
