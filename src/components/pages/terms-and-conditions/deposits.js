            ...
            <AccordionItemPanel className='accordion-item-panel'>
                <ol>
                    <li>
                        ...
                        website (www.BetTena.com).
                    </li>
                    <li>
                        BetTena reserves the right to impose certain conditions on the use
                        of
                        ...
                        suspicious activity of the particular player. BetTena retains the
                        right
                        to change the payment methods available.
                    </li>
                    <li>
                        BetTena does not guarantee that all methods of payment are available
                    ...
                    <li>
                        BetTena reserves the right to request further information and
                        ...
                        entitlement to the balance by some other means. BetTena reserves the
                    ...
                    {/*</li>*/}
                    <li>
                        The player acknowledges that BetTena reserves the right to request
