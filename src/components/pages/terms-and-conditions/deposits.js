            ...
            <AccordionItemPanel className='accordion-item-panel'>
                <ol>
                    <li>
                        ...
                        website (www.Betfusion.com).
                    </li>
                    <li>
                       betfusion reserves the right to impose certain conditions on the use
                        of
                        ...
                        suspicious activity of the particular player.betfusion retains the
                        right
                        to change the payment methods available.
                    </li>
                    <li>
                       betfusion does not guarantee that all methods of payment are available
                    ...
                    <li>
                       betfusion reserves the right to request further information and
                        ...
                        entitlement to the balance by some other means.betfusion reserves the
                    ...
                    {/*</li>*/}
                    <li>
                        The player acknowledges thAt betfusion reserves the right to request
