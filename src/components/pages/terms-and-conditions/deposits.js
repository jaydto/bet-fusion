            ...
            <AccordionItemPanel className='accordion-item-panel'>
                <ol>
                    <li>
                        ...
                        website (www.CrashKali.com).
                    </li>
                    <li>
                        CrashKali reserves the right to impose certain conditions on the use
                        of
                        ...
                        suspicious activity of the particular player. CrashKali retains the
                        right
                        to change the payment methods available.
                    </li>
                    <li>
                        CrashKali does not guarantee that all methods of payment are available
                    ...
                    <li>
                        CrashKali reserves the right to request further information and
                        ...
                        entitlement to the balance by some other means. CrashKali reserves the
                    ...
                    {/*</li>*/}
                    <li>
                        The player acknowledges that CrashKali reserves the right to request
