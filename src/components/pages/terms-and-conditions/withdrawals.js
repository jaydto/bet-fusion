        ...
        <AccordionItem>
            ...
            <AccordionItemPanel className='accordion-item-panel'>
                <ol>
                    ...
                    <li>
                       betfusion’ finance department will handle all withdrawal requests.
                       betfusion reserves the right to verify the account holder's
                        eligibility
                        ...
                        Card)
                        must be submitted in order to process a withdrawal. However,betfusion
                    ...
                    <li>
                        ...
                        on the website www.Betfusion.com.
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        Account (or for any other payment method) must correspond.betfusion
                    ...
                    <li>
                        The maximum self-service withdrawal amount per day, per account will be Kenya Shillings TEN THOUSAND Only (Kshs. 10,000)
                    </li>
                    <li>
                    ...
                    <li>
                        Once a withdrawal request is submitted it can takebetfusion up to Seventy-Two (72) hours to
                        process the request. However,betfusion will be doing its best to process withdrawal requests
                        immediately.
                    </li>
                    <li>
                        In the instance a CLIENT attempts to withdraw funds that were deposited but not used for
                        staking,betfusion may levy up to a processing fee of 50% upon such withdrawals.betfusion reserves
                    ...
                    <li>
                       ...
                       betfusion for the unpaid deposits and for possible expenses resulting
                        from
                        the recollection of the misplaced money.
                    </li>
                    <li>
                        Kindly note thAt betfusion will hold the funds deposited in the
                        Account
                        as trustee for the CLIENT and not as his/her banker or debtor.
                        Accordingly, there will be no obligation on the part ofbetfusion
                        Kenya to
                    ...
                    <li>
                       betfusion at all times reserves the right to refuse and/ or limit
                        bets.
                    </li>
                </ol>
            </AccordionItemPanel>
