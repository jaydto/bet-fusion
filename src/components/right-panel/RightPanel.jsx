        ...
        <>
            <aside
                ...
                style={{
                    ...
                    borderLeft: "1px solid var(--bet-fusion-shadow-borders)"
                }}
            >
                ...
                <Link to="/profile" className="rp-profile-row" style={{ textDecoration: "none" }}>
                    <div className="rp-avatar-wrap">
                        <svg viewBox="0 0 36 36" width="36" height="36" fill="none">
                            {/* Themed Avatar background and person shapes */}
                            <circle cx="18" cy="18" r="18" fill="var(--bet-fusion-shadow-borders)" />
                            <circle cx="18" cy="14" r="6" fill="var(--blue)" />
                            <ellipse cx="18" cy="30" rx="11" ry="7" fill="var(--blue)" />
                        </svg>
                    </div>
                    <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ fontSize: 12, color: "var(--grey)", fontFamily: "'Inter', sans-serif" }}>
                            My Account
                        </div>
                        <div
                            className="rp-profile-label"
                            style={{
                                overflow: "hidden",
                    ...
                    <svg viewBox="0 0 24 24" fill="currentColor" width="14" height="14" style={{ color: "var(--grey)", flexShrink: 0 }}>
                ...
                <div className="rp-section">
                    <div className="rp-section-title" style={{ color: "var(--grey)" }}>
                ...
                {/* Support */}
                <div className="rp-support-bar" style={{ color: "var(--grey)" }}>
                    <MdHeadsetMic size={16} />
                    <span style={{ color: "var(--grey)" }}>Support</span>
                </div>
            </aside>
