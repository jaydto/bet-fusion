    ...
    (props) => {
        ...
        return (<ProSidebar
            ...
            <SidebarHeader className={"background-primary"}>
                ...
                <Menu>
                    <MenuItem className={"d-flex justify-content-between"}>
                        <div className={"d-flex gap-4 align-items-center"}>
                            ...
                            <a href={"tel:0712345678"} onClick={handleClose}>Call Customer Care</a>
                        </div>
                    </MenuItem>
                </Menu>
                <Menu>
                ...
                <Menu>
                    <MenuItem className={"d-flex justify-content-between"}>
                        <a className={"d-flex gap-4 align-items-center"} href={"https://wa.me/+254712345678"} target={"_blank"} rel="noreferrer" onClick={handleClose}>
