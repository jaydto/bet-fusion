                ...
                <Menu>
                    <MenuItem>
                        <div className={"d-flex gap-4 align-items-center px-3"}>
                            <FontAwesomeIcon icon={faMobile} style={{fontSize:'24px'}}/>
                            <a href={"/https://cdn.Jazabets.com/Jazabetsapp.apk"} className={'text-profile'} onClick={() => {
                ...
                <Menu>
                    <MenuItem>
                        <div className={"d-flex gap-4 align-items-center px-3"}>
                            ...
                            <a href={"https://wa.me/+254111513541"} target={"_blank"} className={'text-profile'}>Whatsapp Us</a>
                        </div>
                    </MenuItem>
                </Menu>
                <Menu>
                    <MenuItem>
                        <div className={"d-flex gap-4 align-items-center px-3"}>
                            ...
                            <a href={'javascript:void(0)'} className={'text-profile'}>0111513541</a>
                        </div>
                    </MenuItem>
                </Menu>
            </SidebarFooter>
